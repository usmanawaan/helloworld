...
<?php endif; ?>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="header text-uppercase">Shop</li>
                        <li class="treeview <?=active_link_controller('products')?>">
                            ...
                            <ul class="treeview-menu">
                                <li class="<?=active_link_function('index')?>"><a href="<?php echo site_url('admin/products/'); ?>">View Products</a></li>
                                <li class="<?=active_link_function('create')?>"><a href="<?php echo site_url('admin/products/create'); ?>">Create Product</a></li>
                                <li class="<?=active_link_function('trash')?>"><a href="<?php echo site_url('admin/products/trash'); ?>">Product Trash</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="header text-uppercase"><?php //echo $nntitle; ?></li>
